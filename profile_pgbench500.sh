...
setsid ./profile_perf_L1.sh L1-dcache-load-misses 10 $1 perf_savepoint500_L1-lm.out 6 >./logfile0 2>&1 < /dev/null &
...
setsid ./profile_perf_L1.sh l2_rqsts.miss 5 $1 perf_savepoint500_L2-all.out 6 >./logfile2 2>&1 < /dev/null &
